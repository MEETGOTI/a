...
class exercises_2 extends StatefulWidget {
  const exercises_2({Key? key}) : super(key: key);

  @override
  State<exercises_2> createState() => _exercises_2State();
}

// ignore: camel_case_types
class _exercises_2State extends State<exercises_2> {
  @override
