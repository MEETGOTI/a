...
class exercises_1 extends StatefulWidget {
  const exercises_1({Key? key}) : super(key: key);

  @override
  State<exercises_1> createState() => _exercises_1State();
}

// ignore: camel_case_types
class _exercises_1State extends State<exercises_1> {
  @override
