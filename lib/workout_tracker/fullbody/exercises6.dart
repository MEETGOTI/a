...
class exercises_6 extends StatefulWidget {
  const exercises_6({Key? key}) : super(key: key);

  @override
  State<exercises_6> createState() => _exercises_6State();
}

// ignore: camel_case_types
class _exercises_6State extends State<exercises_6> {
  @override
