...
class body_start extends StatefulWidget {
  const body_start({Key? key}) : super(key: key);

  @override
  State<body_start> createState() => _body_startState();
}

// ignore: camel_case_types
class _body_startState extends State<body_start> with TickerProviderStateMixin {
  var data = [
    {
      "name": "Warm Up",
