...
class ab_start extends StatefulWidget {
  const ab_start({Key? key}) : super(key: key);

  @override
  State<ab_start> createState() => _ab_startState();
}

// ignore: camel_case_types
class _ab_startState extends State<ab_start> with TickerProviderStateMixin {
  var data = [
    {
      "name": "Warm Up",
      "image":
