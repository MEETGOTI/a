...
class bad_time2 extends StatefulWidget {
  const bad_time2({Key? key}) : super(key: key);

  @override
  State<bad_time2> createState() => _bad_time2State();
}

// ignore: camel_case_types
class _bad_time2State extends State<bad_time2> {
  @override
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () => Get.to(const badtime_set2()),
              child: Container(
                height: 50,
