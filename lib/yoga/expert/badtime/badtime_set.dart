import 'package:fittnessapp/yoga/expert/badtime/badtime_start.dart';
import 'package:fittnessapp/yoga/expert/badtime/badtime_yoga.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

// ignore: camel_case_types
class badtime_set2 extends StatefulWidget {
  const badtime_set2({Key? key}) : super(key: key);

  @override
  State<badtime_set2> createState() => _badtime_set2State();
}

// ignore: camel_case_types
class _badtime_set2State extends State<badtime_set2> {
  @override
          ...
          children: [
            Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const bad_time2()),
                  child: const Icon(
    ...
    return Column(
      children: [
        Padding(
          ...
          child: InkWell(
            onTap: () => Get.to(const badtime_start2()),
            child: Container(
              height: 50,
