...
import 'package:fittnessapp/yoga/expert/inner_peace/inner_peace_start.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

// ignore: camel_case_types
class inner_peace_set2 extends StatefulWidget {
  const inner_peace_set2({Key? key}) : super(key: key);

  @override
  State<inner_peace_set2> createState() => _inner_peace_set2State();
}

// ignore: camel_case_types
class _inner_peace_set2State extends State<inner_peace_set2> {
  @override
          ...
          children: [
            Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const inner_peace2()),
                  child: const Icon(
    ...
    return Column(
      children: [
        Padding(
          ...
          child: InkWell(
            onTap: () => Get.to(const inner_peace_start2()),
            child: Container(
              height: 50,
