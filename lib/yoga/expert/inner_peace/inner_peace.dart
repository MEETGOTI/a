...
class inner_peace2 extends StatefulWidget {
  const inner_peace2({Key? key}) : super(key: key);

  @override
  State<inner_peace2> createState() => _inner_peace2State();
}

// ignore: camel_case_types
class _inner_peace2State extends State<inner_peace2> {
  @override
