...
import 'package:fittnessapp/yoga/expert/inner_peace/inner_peace_set.dart';
...
class inner_peace_start2 extends StatefulWidget {
  const inner_peace_start2({Key? key}) : super(key: key);

  @override
  State<inner_peace_start2> createState() => _inner_peace_start2State();
}

// ignore: camel_case_types
class _inner_peace_start2State extends State<inner_peace_start2> {
  @override
            ...
            children: [
              Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const inner_peace_set2()),
                  child: const Icon(
