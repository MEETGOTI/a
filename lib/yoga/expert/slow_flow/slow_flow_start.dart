...
class slow_flow_start2 extends StatefulWidget {
  const slow_flow_start2({Key? key}) : super(key: key);

  @override
  State<slow_flow_start2> createState() => _slow_flow_start2State();
}

// ignore: camel_case_types
class _slow_flow_start2State extends State<slow_flow_start2> {
  @override
            ...
            children: [
              Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const slow_flow_set2()),
                  child: const Icon(
