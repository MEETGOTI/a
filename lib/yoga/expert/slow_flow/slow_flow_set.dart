...
import 'package:fittnessapp/yoga/expert/slow_flow/slow_flow_start.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

// ignore: camel_case_types
class slow_flow_set2 extends StatefulWidget {
  const slow_flow_set2({Key? key}) : super(key: key);

  @override
  State<slow_flow_set2> createState() => _slow_flow_set2State();
}

// ignore: camel_case_types
class _slow_flow_set2State extends State<slow_flow_set2> {
  @override
          ...
          children: [
            Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const Slow_flow2()),
                  child: const Icon(
    ...
    return Column(
      children: [
        Padding(
          ...
          child: InkWell(
            onTap: () => Get.to(const slow_flow_start2()),
            child: Container(
              height: 50,
