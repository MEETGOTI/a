...
import 'package:fittnessapp/yoga/expert/slow_strech/slow_strech_set.dart';
...
class slow_strech_start2 extends StatefulWidget {
  const slow_strech_start2({Key? key}) : super(key: key);

  @override
  State<slow_strech_start2> createState() => _slow_strech_start2State();
}

// ignore: camel_case_types
class _slow_strech_start2State extends State<slow_strech_start2> {
  @override
