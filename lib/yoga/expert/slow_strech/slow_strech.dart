...
class Slow_strech2 extends StatefulWidget {
  const Slow_strech2({Key? key}) : super(key: key);

  @override
  State<Slow_strech2> createState() => _Slow_strech2State();
}

// ignore: camel_case_types
class _Slow_strech2State extends State<Slow_strech2> {
  @override
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () => Get.to(const slow_strech_set2()),
              child: Container(
                height: 50,
