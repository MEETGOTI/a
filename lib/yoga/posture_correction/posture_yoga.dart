...
import 'package:fittnessapp/yoga/posture_correction/posture_yoga_start.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

// ignore: camel_case_types
class posture_yoga_set extends StatefulWidget {
  const posture_yoga_set({Key? key}) : super(key: key);

  @override
  State<posture_yoga_set> createState() => _posture_yoga_setState();
}

// ignore: camel_case_types
class _posture_yoga_setState extends State<posture_yoga_set> {
  @override
    ...
    return Column(
      children: [
        Padding(
          ...
          child: InkWell(
            onTap: () => Get.to(const posture_yoga_start()),
            child: Container(
              height: 50,
