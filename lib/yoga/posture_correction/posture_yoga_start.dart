...
class posture_yoga_start extends StatefulWidget {
  const posture_yoga_start({Key? key}) : super(key: key);

  @override
  State<posture_yoga_start> createState() => _posture_yoga_startState();
}

// ignore: camel_case_types
class _posture_yoga_startState extends State<posture_yoga_start> {
  @override
            ...
            children: [
              Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const posture_yoga_set()),
                  child: const Icon(
