...
class bad_time extends StatefulWidget {
  const bad_time({Key? key}) : super(key: key);

  @override
  State<bad_time> createState() => _bad_timeState();
}

// ignore: camel_case_types
class _bad_timeState extends State<bad_time> {
  @override
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () => Get.to(const badtime_set()),
              child: Container(
                height: 50,
