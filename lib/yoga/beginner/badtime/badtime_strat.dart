...
class badtime_start extends StatefulWidget {
  const badtime_start({Key? key}) : super(key: key);

  @override
  State<badtime_start> createState() => _badtime_startState();
}

// ignore: camel_case_types
class _badtime_startState extends State<badtime_start> {
  @override
            ...
            children: [
              Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const badtime_set()),
                  child: const Icon(
