...
class inner_peace extends StatefulWidget {
  const inner_peace({Key? key}) : super(key: key);

  @override
  State<inner_peace> createState() => _inner_peaceState();
}

// ignore: camel_case_types
class _inner_peaceState extends State<inner_peace> {
  @override
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () => Get.to(const inner_peace_set()),
              child: Container(
                height: 50,
