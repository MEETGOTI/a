...
import 'package:fittnessapp/yoga/beginner/inner_peace/inner_peace_set.dart';
...
class inner_peace_start extends StatefulWidget {
  const inner_peace_start({Key? key}) : super(key: key);

  @override
  State<inner_peace_start> createState() => _inner_peace_startState();
}

// ignore: camel_case_types
class _inner_peace_startState extends State<inner_peace_start> {
  @override
            ...
            children: [
              Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const inner_peace_set()),
                  child: const Icon(
