...
import 'inner_peace_start.dart';

// ignore: camel_case_types
class inner_peace_set extends StatefulWidget {
  const inner_peace_set({Key? key}) : super(key: key);

  @override
  State<inner_peace_set> createState() => _inner_peace_setState();
}

// ignore: camel_case_types
class _inner_peace_setState extends State<inner_peace_set> {
  @override
          ...
          children: [
            Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const inner_peace()),
                  child: const Icon(
    ...
    return Column(
      children: [
        Padding(
          ...
          child: InkWell(
            onTap: () => Get.to(const inner_peace_start()),
            child: Container(
              height: 50,
