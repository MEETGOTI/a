...
class show_strech_start extends StatefulWidget {
  const show_strech_start({Key? key}) : super(key: key);

  @override
  State<show_strech_start> createState() => _show_strech_startState();
}

// ignore: camel_case_types
class _show_strech_startState extends State<show_strech_start> {
  @override
            ...
            children: [
              Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const show_strech_set()),
                  child: const Icon(
