...
import 'package:fittnessapp/yoga/beginner/show_strech/slow_strech_start.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

// ignore: camel_case_types
class show_strech_set extends StatefulWidget {
  const show_strech_set({Key? key}) : super(key: key);

  @override
  State<show_strech_set> createState() => _show_strech_setState();
}

// ignore: camel_case_types
class _show_strech_setState extends State<show_strech_set> {
  @override
    ...
    return Column(
      children: [
        Padding(
          ...
          child: InkWell(
            onTap: () => Get.to(const show_strech_start()),
            child: Container(
              height: 50,
