...
class Slow_flow extends StatefulWidget {
  const Slow_flow({Key? key}) : super(key: key);

  @override
  State<Slow_flow> createState() => _Slow_flowState();
}

// ignore: camel_case_types
class _Slow_flowState extends State<Slow_flow> {
  @override
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () => Get.to(const show_flow_set()),
              child: Container(
                height: 50,
