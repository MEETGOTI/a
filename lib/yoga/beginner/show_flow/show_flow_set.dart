...
import 'package:fittnessapp/yoga/beginner/show_flow/slow_flow_start.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

// ignore: camel_case_types
class show_flow_set extends StatefulWidget {
  const show_flow_set({Key? key}) : super(key: key);

  @override
  State<show_flow_set> createState() => _show_flow_setState();
}

// ignore: camel_case_types
class _show_flow_setState extends State<show_flow_set> {
  @override
          ...
          children: [
            Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const Slow_flow()),
                  child: const Icon(
    ...
    return Column(
      children: [
        Padding(
          ...
          child: InkWell(
            onTap: () => Get.to(const show_flow_start()),
            child: Container(
              height: 50,
