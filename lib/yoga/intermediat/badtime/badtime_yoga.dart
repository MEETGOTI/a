...
class bad_time1 extends StatefulWidget {
  const bad_time1({Key? key}) : super(key: key);

  @override
  State<bad_time1> createState() => _bad_time1State();
}

// ignore: camel_case_types
class _bad_time1State extends State<bad_time1> {
  @override
