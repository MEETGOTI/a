...
class badime_start1 extends StatefulWidget {
  const badime_start1({Key? key}) : super(key: key);

  @override
  State<badime_start1> createState() => _badime_start1State();
}

// ignore: camel_case_types
class _badime_start1State extends State<badime_start1> {
  @override
