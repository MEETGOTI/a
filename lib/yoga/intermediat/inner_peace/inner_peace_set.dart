...
class inner_set1 extends StatefulWidget {
  const inner_set1({Key? key}) : super(key: key);

  @override
  State<inner_set1> createState() => _inner_set1State();
}

// ignore: camel_case_types
class _inner_set1State extends State<inner_set1> {
  @override
    ...
    return Column(
      children: [
        Padding(
          ...
          child: InkWell(
            onTap: () => Get.to(() => const inner_start1()),
            child: Container(
              height: 50,
