...
class inner_peace1 extends StatefulWidget {
  const inner_peace1({Key? key}) : super(key: key);

  @override
  State<inner_peace1> createState() => _inner_peace1State();
}

// ignore: camel_case_types
class _inner_peace1State extends State<inner_peace1> {
  @override
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () => Get.to(() => const badtime_set1()),
              child: Container(
                height: 50,
