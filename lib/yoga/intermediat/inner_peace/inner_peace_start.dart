...
class inner_start1 extends StatefulWidget {
  const inner_start1({Key? key}) : super(key: key);

  @override
  State<inner_start1> createState() => _inner_start1State();
}

// ignore: camel_case_types
class _inner_start1State extends State<inner_start1> {
  @override
            ...
            children: [
              Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(() => const inner_set1()),
                  child: const Icon(
