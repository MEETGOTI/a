import 'package:fittnessapp/yoga/intermediat/show_strech/show_strech_start.dart';
import 'package:fittnessapp/yoga/intermediat/show_strech/slow_strech.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

// ignore: camel_case_types
class Slow_strech_set1 extends StatefulWidget {
  const Slow_strech_set1({Key? key}) : super(key: key);

  @override
  State<Slow_strech_set1> createState() => _Slow_strech_set1State();
}

// ignore: camel_case_types
class _Slow_strech_set1State extends State<Slow_strech_set1> {
  @override
          ...
          children: [
            Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(() => const Slow_strech1()),
                  child: const Icon(
            ...
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(builder: (context) {
                  return const Slow_strech_start1();
                }),
              );
            },
            child: Container(
