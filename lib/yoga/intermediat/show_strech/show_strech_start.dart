...
class Slow_strech_start1 extends StatefulWidget {
  const Slow_strech_start1({Key? key}) : super(key: key);

  @override
  State<Slow_strech_start1> createState() => _Slow_strech_start1State();
}

// ignore: camel_case_types
class _Slow_strech_start1State extends State<Slow_strech_start1> {
  @override
            ...
            children: [
              Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(() => const Slow_strech_set1()),
                  child: const Icon(
