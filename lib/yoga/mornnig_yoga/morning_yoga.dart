...
import 'package:fittnessapp/yoga/mornnig_yoga/morning_yoga_start.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

// ignore: camel_case_types
class morning_yoga_set extends StatefulWidget {
  const morning_yoga_set({Key? key}) : super(key: key);

  @override
  State<morning_yoga_set> createState() => _morning_yoga_setState();
}

// ignore: camel_case_types
class _morning_yoga_setState extends State<morning_yoga_set> {
  @override
    ...
    return Column(
      children: [
        Padding(
          ...
          child: InkWell(
            onTap: () => Get.to(const morning_yoga_start()),
            child: Container(
              height: 50,
