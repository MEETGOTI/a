...
class morning_yoga_start extends StatefulWidget {
  const morning_yoga_start({Key? key}) : super(key: key);

  @override
  State<morning_yoga_start> createState() => _morning_yoga_startState();
}

// ignore: camel_case_types
class _morning_yoga_startState extends State<morning_yoga_start> {
  @override
            ...
            children: [
              Padding(
                ...
                child: MaterialButton(
                  ...
                  height: 30,
                  minWidth: 15,
                  onPressed: () => Get.to(const morning_yoga_set()),
                  child: const Icon(
